package org.csc301.mongodb.dao;
...
import org.csc301.mongodb.converter.PersonConverter;
import org.csc301.mongodb.model.Person;
...
//DAO: Data Access Object Pattern is used to separate low level 
...
public class MongoDBPersonDAO {
	...
	public MongoDBPersonDAO(MongoClient mongo) {
		this.col = mongo.getDB("csc301").getCollection("Persons");
	}
